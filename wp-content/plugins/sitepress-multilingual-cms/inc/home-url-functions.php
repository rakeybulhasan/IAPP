<?php
  ...
  function wpml_home_url_save_post_actions($pidd, $post){
      ...
      if(isset($_POST['_wpml_root_page']) && $_POST['_wpml_root_page']){
          ...
          if(isset($_POST['autosave']) || (isset($post->post_type) && $post->post_type == 'revision')) return;
  ...
  function wpml_home_url_ls_hide_check(){
      ...
      $hide = 
          ...
          $sitepress_settings['urls']['directory_for_default_language'] && 
          $sitepress_settings['urls']['show_on_root'] == 'page' && 
          $sitepress_settings['urls']['hide_language_switchers'] && 
          isset($sitepress->ROOT_URL_PAGE_ID) &&
          $sitepress->ROOT_URL_PAGE_ID == $sitepress_settings['urls']['root_page'];
