...
<div class="wrap">
	...
	<ul>
		...
		<li>- <a href="http://www.mapsmarker.com/login" target="_blank">mapsmarker.com/login</a> (<?php _e('support for pro users','lmm'); ?>)</li>
	</ul>
	...
	<ul>
		...
		<li>- Czech (cs_CZ) thanks to Viktor Kleiner Czech and Vlad Kuzba, <a href="http://kuzbici.eu" target="_blank">http://kuzbici.eu</a></li>
		...
		<li>- Indonesian (id_ID) thanks to Andy Aditya Sastrawikarta, Emir Hartato, <a href="http://whateverisaid.wordpress.com" target="_blank">http://whateverisaid.wordpress.com</a></li>
	...
	<ul>
		...
		<li>- Plus-, json-, layer-, language-, exclamation- &amp; csv-export-icon from <a href="http://p.yusukekamiyamane.com/" target="_blank">Yusuke Kamiyamane</a>, licence: Creative Commons Attribution (by)</li>
		...
		<li>- Personalized avatar icon by <a href="http://semlabs.co.uk/" target="_blank">David Hopkins</a>, licence: Creative Commons Attribution (by)</li>
		<li>- Anonymous avatar icon by <a href="http://www.iconshock.com/" target="_blank">Icon Shock</a>, licence: Creative Commons Attribution (by)</li>
