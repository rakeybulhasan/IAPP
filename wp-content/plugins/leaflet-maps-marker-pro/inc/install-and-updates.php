...
if (get_option('leafletmapsmarker_version') == 'x.x' ) {
	delete_transient( 'leafletmapsmarker_install_update_cache_vxx');
	...
	if ( $version_before_update === FALSE ) {
		set_transient( 'leafletmapsmarker_version_before_update', 'deleted-in-1-hour', 60*3 );
		update_option('leafletmapsmarker_version_before_update', 'x.x');
	}
...
if (get_option('leafletmapsmarker_version_pro') == 'init' ) {
	...
	if ( $version_before_update === FALSE ) {
		set_transient( 'leafletmapsmarker_version_pro_before_update', 'deleted-in-1-hour', 60*3 );
...
if (get_option('leafletmapsmarker_version_pro') == '1.0' ) {
	delete_transient( 'leafletmapsmarker_install_update_cache_vp10');
	$save_defaults_for_new_options = new Class_leaflet_options();
	$save_defaults_for_new_options->save_defaults_for_new_options();
	$version_before_update = get_transient( 'leafletmapsmarker_version_pro_before_update' );
	if ( $version_before_update === FALSE ) {
...
if (get_option('leafletmapsmarker_version_pro') == '1.1' ) {
	delete_transient( 'leafletmapsmarker_install_update_cache_vp11');
	$version_before_update = get_transient( 'leafletmapsmarker_version_pro_before_update' );
	if ( $version_before_update === FALSE ) {
		set_transient( 'leafletmapsmarker_version_pro_before_update', 'deleted-in-1-hour', 60*3 );
...
if (get_option('leafletmapsmarker_version_pro') == '1.1.1' ) {
	delete_transient( 'leafletmapsmarker_install_update_cache_vp111');
	$version_before_update = get_transient( 'leafletmapsmarker_version_pro_before_update' );
	if ( $version_before_update === FALSE ) {
		set_transient( 'leafletmapsmarker_version_pro_before_update', 'deleted-in-1-hour', 60*3 );
...
if (get_option('leafletmapsmarker_version_pro') == '1.1.2' ) {
	delete_transient( 'leafletmapsmarker_install_update_cache_vp112');
	$save_defaults_for_new_options = new Class_leaflet_options();
	$save_defaults_for_new_options->save_defaults_for_new_options();
	$version_before_update = get_transient( 'leafletmapsmarker_version_pro_before_update' );
	if ( $version_before_update === FALSE ) {
...
if (get_option('leafletmapsmarker_version_pro') == '1.2' ) {
	delete_transient( 'leafletmapsmarker_install_update_cache_vp12');
	$version_before_update = get_transient( 'leafletmapsmarker_version_pro_before_update' );
	if ( $version_before_update === FALSE ) {
		set_transient( 'leafletmapsmarker_version_pro_before_update', 'deleted-in-1-hour', 60*3 );
...
if (get_option('leafletmapsmarker_version_pro') == '1.2.1' ) {
	delete_transient( 'leafletmapsmarker_install_update_cache_vp121');
	$save_defaults_for_new_options = new Class_leaflet_options();
	$save_defaults_for_new_options->save_defaults_for_new_options();
	$version_before_update = get_transient( 'leafletmapsmarker_version_pro_before_update' );
	if ( $version_before_update === FALSE ) {
...
if (get_option('leafletmapsmarker_version_pro') == '1.3' ) {
	delete_transient( 'leafletmapsmarker_install_update_cache_vp13');
	$save_defaults_for_new_options = new Class_leaflet_options();
	$save_defaults_for_new_options->save_defaults_for_new_options();
	$version_before_update = get_transient( 'leafletmapsmarker_version_pro_before_update' );
	if ( $version_before_update === FALSE ) {
...
if (get_option('leafletmapsmarker_version_pro') == '1.3.1' ) {
	delete_transient( 'leafletmapsmarker_install_update_cache_vp131');
	$version_before_update = get_transient( 'leafletmapsmarker_version_pro_before_update' );
	if ( $version_before_update === FALSE ) {
		set_transient( 'leafletmapsmarker_version_pro_before_update', 'deleted-in-1-hour', 60*3 );
...
if (get_option('leafletmapsmarker_version_pro') == '1.4' ) {
	delete_transient( 'leafletmapsmarker_install_update_cache_vp14');
	$save_defaults_for_new_options = new Class_leaflet_options();
	$save_defaults_for_new_options->save_defaults_for_new_options();
	$version_before_update = get_transient( 'leafletmapsmarker_version_pro_before_update' );
	if ( $version_before_update === FALSE ) {
...
if (get_option('leafletmapsmarker_version_pro') == '1.5' ) {
	delete_transient( 'leafletmapsmarker_install_update_cache_vp15');
	$version_before_update = get_transient( 'leafletmapsmarker_version_pro_before_update' );
	if ( $version_before_update === FALSE ) {
		set_transient( 'leafletmapsmarker_version_pro_before_update', 'deleted-in-1-hour', 60*3 );
...
if (get_option('leafletmapsmarker_version_pro') == '1.xbefore' ) {
	delete_transient( 'leafletmapsmarker_install_update_cache_vpxx'); //2do: update to version from line above
	...
	if ( $version_before_update === FALSE ) {
		set_transient( 'leafletmapsmarker_version_pro_before_update', 'deleted-in-1-hour', 60*3 );
		update_option('leafletmapsmarker_version_pro_before_update', '1.xbefore'); //2do - update to version before update
	}
	update_option('leafletmapsmarker_version_pro', '1.xneu');
	...
	//2do - update free version install-and-update-code too if released together
}
*/
?>