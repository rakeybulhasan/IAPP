...
class Class_leaflet_options {
	...
	public function get_settings() {
		...
		$pro_option = '<br/><img src="'. LEAFLET_PLUGIN_URL .'inc/img/help-pro-option.png" width="65" height="15" />';
		...
		*/
		...
		$this->_settings['global_maxzoom_level'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section1',
			'title'   => __('Global maximum zoom level','lmm') . $pro_option,
		...
		*/
		...
		$this->_settings['defaults_marker_custom_icon_url_dir'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section5',
			'title'   => __('Use custom icon URL and directory','lmm') . $pro_option,
		...
		$this->_settings['defaults_marker_icon_url'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section5',
			'title'   => __( 'Custom icons URL', 'lmm' ) . $pro_option,
		...
		$this->_settings['defaults_marker_icon_dir'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section5',
			'title'   => __( 'Custom icons directory', 'lmm' ) . $pro_option,
		...
		*/
		...
		$this->_settings['defaults_layer_clustering'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section8',
			'title'   => __('Marker clustering','lmm') . $pro_option,
			'desc'    => '',
			'type'    => 'radio',
			'std'     => 'enabled',
			'choices' => array(
		...
		*/
		...
		$this->_settings['map_fullscreen_button'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section13',
			'title'   => __('Fullscreen button','lmm') . $pro_option,
			'desc'    => __('Whether to add a button for displaying maps in fullscreen via HTML5','lmm') . '<br/><img src="'. LEAFLET_PLUGIN_URL .'inc/img/help-fullscreen.png" width="83" height="115" />',
			'type'    => 'radio',
			'std'     => 'true',
			'choices' => array(
				'true' => __('true','lmm'),
		...
		$this->_settings['map_fullscreen_button_position'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section13',
			'title'   => __('Fullscreen button position','lmm') . $pro_option,
		...
		*/
		...
		$this->_settings['map_webapp_images'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section16',
			'title'   => __('Images to use','lmm') . $pro_option,
		...
		$this->_settings['map_webapp_icon57'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section16',
			'title'   => __('App icon URL','lmm') . $pro_option,
		...
		$this->_settings['map_webapp_launch1024'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section16',
			'title'   => __('Launch image URL','lmm') . $pro_option,
		...
		*/
		$this->_settings['minimap_helptext'] = array(
			...
			'std'     => '',
			'title'   => '',
			'desc'    => __( 'Add an expandable minimap to your maps which shows the same as the main map with a set zoom offset', 'lmm') . '<br/><img src="'. LEAFLET_PLUGIN_URL .'inc/img/help-minimap.jpg" width="400" height="183" />',
			'type'    => 'helptext'
		);
		$this->_settings['minimap_status'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section17',
			'title'   => __('Status','lmm') . $pro_option,
			'desc'    => '',
			'type'    => 'radio',
			'std'     => 'collapsed',
			'choices' => array(
		...
		$this->_settings['minimap_basemap'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section17',
			'title'   => __('Basemap','lmm') . $pro_option,
		...
		$this->_settings['minimap_position'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section17',
			'title'   => __('Position','lmm') . $pro_option,
			'desc'    => '',
			'type'    => 'radio',
			'std'     => 'bottomright',
			'choices' => array(
		...
		$this->_settings['minimap_height'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section17',
			'title'   => __('Height','lmm') . $pro_option,
		...
		$this->_settings['minimap_zoomLevelOffset'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section17',
			'title'   => 'zoomLevelOffset' . $pro_option,
		...
		$this->_settings['minimap_zoomLevelFixed'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section17',
			'title'   =>'zoomLevelFixed' . $pro_option,
		...
		$this->_settings['minimap_zoomAnimation'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section17',
			'title'   => 'zoomAnimation' . $pro_option,
		...
		$this->_settings['minimap_toggleDisplay'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section17',
			'title'   => 'toggleDisplay' . $pro_option,
		...
		$this->_settings['minimap_autoToggleDisplay'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section17',
			'title'   => 'autoToggleDisplay' . $pro_option,
		...
		*/
		...
		$this->_settings['clustering_zoomToBoundsOnClick'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section18',
			'title'   => 'zoomToBoundsOnClick' . $pro_option,
			'desc'    => __('When you click a cluster it zooms to its bounds','lmm') . '. ' . __('If set to false, zooming into clusters is only possible by clicking on + in the zoom control box or by mouse wheel (if enabled)','lmm'),
			'type'    => 'radio',
			'std'     => 'true',
			'choices' => array(
				'true' => __('true','lmm'),
		...
		$this->_settings['clustering_showCoverageOnHover'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section18',
			'title'   => 'showCoverageOnHover' . $pro_option,
		...
		$this->_settings['clustering_spiderfyOnMaxZoom'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section18',
			'title'   => 'spiderfyOnMaxZoom' . $pro_option,
		...
		$this->_settings['clustering_disableClusteringAtZoom'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section18',
			'title'   =>'disableClusteringAtZoom' . $pro_option,
		...
		$this->_settings['clustering_maxClusterRadius'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section18',
			'title'   =>'maxClusterRadius' . $pro_option,
		...
		$this->_settings['clustering_helptext2'] = array(
			...
			'section' => 'mapdefaults-section18',
			'std'     => '',
			'title'   =>'polygonOptions' . $pro_option,
		...
		$this->_settings['clustering_helptext3'] = array(
			...
			'section' => 'mapdefaults-section18',
			'std'     => '',
			'title'   => __('Cluster colors','lmm') . $pro_option,
		...
		$this->_settings['clustering_singleMarkerMode'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section18',
			'title'   => 'singleMarkerMode' . $pro_option,
		...
		$this->_settings['clustering_spiderfyDistanceMultiplier'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section18',
			'title'   =>'spiderfyDistanceMultiplier' . $pro_option,
		...
		$this->_settings['clustering_animateAddingMarkers'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section18',
			'title'   => 'animateAddingMarkers' . $pro_option,
		...
		*/
		$this->_settings['gpx_helptext'] = array(
			...
			'std'     => '',
			'title'   => '',
			'desc'    => '<img src="'. LEAFLET_PLUGIN_URL .'inc/img/help-gpx.jpg" width="449" height="263" /><br/>' . __( 'Settings below will be applied to all GPX tracks added to marker or layer maps.', 'lmm'),
			'type'    => 'helptext'
		);
		$this->_settings['gpx_track_color'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section19',
			'title'   => __('Polygon options','lmm'). $pro_option,
		...
		$this->_settings['gpx_metadata_units'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section19',
			'title'   => __('GPX metadata settings','lmm') . $pro_option,
		...
		$this->_settings['gpx_max_point_interval'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section19',
			'title'   => __('Maximum interval between points','lmm') . $pro_option,
		...
		$this->_settings['gpx_startIconUrl'] = array(
			...
			'pane'    => 'mapdefaults',
			'section' => 'mapdefaults-section19',
			'title'   => __('GPX icon settings','lmm') . $pro_option,
		...
		*/
		...
		$this->_settings['google_adsense_status'] = array(
			...
			'pane'    => 'google',
			'section' => 'google-section6',
			'title'   => 'Google Adsense' . $pro_option,
		...
		$this->_settings['google_adsense_format'] = array(
			...
			'pane'    => 'google',
			'section' => 'google-section6',
			'title'   => __('Format','lmm') . $pro_option,
		...
		$this->_settings['google_adsense_backgroundColor'] = array(
			...
			'pane'    => 'google',
			'section' => 'google-section6',
			'title'   => 'backgroundColor' . $pro_option,
		...
		$this->_settings['google_adsense_channelNumber'] = array(
			...
			'pane'    => 'google',
			'section' => 'google-section6',
			'title'   => 'channelNumber' . $pro_option,
		...
		*/
		...
		$this->_settings['ar_wikitude_description'] = array(
			...
			'pane'    => 'ar',
			'section' => 'ar-section1',
			'title'   => __( 'Description', 'lmm' ) . $pro_option,
		...
		*
		...
		$this->_settings['misc_backlinks'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section1',
			'title'   => __('MapsMarker.com backlinks','lmm') . $pro_option,
		...
		$this->_settings['capabilities_edit_others'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section1',
			'title'   => __( 'User role needed for editing markers/layers from other users', 'lmm' ) . $pro_option,
			'desc'    => '',
			'type'    => 'radio',
			'std'     => 'edit_posts',
			'choices' => array(
		...
		$this->_settings['capabilities_delete_others'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section1',
			'title'   => __( 'User role needed for deleting markers/layers from other users', 'lmm' ) . $pro_option,
			'desc'    => '',
			'type'    => 'radio',
			'std'     => 'edit_posts',
			'choices' => array(
	...
	$this->_settings['misc_projections'] = array(
		...
		$this->_settings['misc_betatest'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section1',
			'title'   => __('Beta testing','lmm') . $pro_option,
		...
		$this->_settings['misc_whitelabel_backend'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section1',
			'title'   => __('Whitelabel backend','lmm') . $pro_option,
		...
		*/
		...
		$this->_settings['qrcode_visualead_helptext'] = array(
			...
			'section' => 'misc-section8',
			'std'     => '',
			'title'   => '<strong>' . __('Visualead settings','lmm') . '</strong><br/><img src="'. LEAFLET_PLUGIN_URL .'inc/img/help-qr-visualead-preview.png" width="200" height="200" />',
			'desc'    => '',
			'type'    => 'helptext'
		);
		$this->_settings['qrcode_visualead_caching'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section8',
			'title'   => __('QR code caching','lmm') . $pro_option,
			'desc'    => __('Save generated QR codes in the following directory for higher performance and for saving API calls:','lmm') . '<br/>' . LEAFLET_PLUGIN_QR_DIR . '<br/>' . __('Cached QR images will automatically be deleted if the according marker or layer map gets deleted!','lmm'),
			'type'    => 'radio',
			'std'     => 'enabled',
			'choices' => array(
				'enabled' => __('enabled','lmm'),
		...
		$this->_settings['qrcode_visualead_api_key'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section8',
			'title'   => __( 'API key', 'lmm' ) . $pro_option,
		...
		$this->_settings['qrcode_visualead_image_url'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section8',
			'title'   => __( 'Image URL', 'lmm' ) . $pro_option,
		...
		$this->_settings['qrcode_visualead_qr_size'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section8',
			'title'   => __( 'QR size', 'lmm' ) . $pro_option,
		...
		$this->_settings['qrcode_visualead_qr_cell_size'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section8',
			'title'   => __( 'QR cell size', 'lmm' ) . $pro_option,
		...
		$this->_settings['qrcode_visualead_qr_gravity'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section8',
			'title'   => __( 'QR gravity', 'lmm' ) . $pro_option,
		...
		$this->_settings['qrcode_visualead_qr_rotation'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section8',
			'title'   => __( 'QR rotation', 'lmm' ) . $pro_option,
		...
		$this->_settings['qrcode_visualead_output_image_width'] = array(
			...
			'pane'    => 'misc',
			'section' => 'misc-section8',
			'title'   => __( 'Output image width', 'lmm' ) . $pro_option,
	...
	public function initialize_settings() {
		...
		foreach ( $this->settings as $id => $setting ) {
			if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' ) {
	...
	*/
	...
	public function save_defaults_for_new_options() {
		...
		if (get_option('leafletmapsmarker_version') == '1.0' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '1.1')
				{
		...
		if (get_option('leafletmapsmarker_version') == '1.1' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '1.2')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '1.3' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '1.4')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '1.4.2' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '1.4.3')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '1.4.3' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '1.5')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '1.5.1' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '1.6')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '1.6' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '1.7')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '1.7' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '1.8')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '1.8' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '1.9')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '2.0' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '2.1')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '2.1' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '2.2')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '2.2' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '2.3')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '2.3' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '2.4')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '2.4' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '2.5')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '2.5' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '2.6')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '2.7' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '2.7.1')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '2.7.1' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '2.8')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '2.8.2' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '2.9')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '2.9.2' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '3.0')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '3.0' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '3.1')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '3.1' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '3.2')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '3.2.1' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '3.2.2')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '3.2.5' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '3.3')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '3.3' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '3.4')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '3.4.3' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '3.5')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '3.5.1' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '3.5.2')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '3.5.4' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '3.6')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		//info:  set defaults for options introduced in v3.6.4
		if (get_option('leafletmapsmarker_version') == '3.6.3' )
		{
			$new_options_defaults = array();
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '3.6.4')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version') == '3.8.1' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == '3.8.1')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		*/
		...
		if (get_option('leafletmapsmarker_version_pro') == 'init' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p1.0')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		//info:  set defaults for options introduced in pro version 1.1
		if (get_option('leafletmapsmarker_version_pro') == '1.0' )
		{
			$new_options_defaults = array();
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p1.1')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		if (get_option('leafletmapsmarker_version_pro') == '1.1.2' )
		{
			...
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p1.2')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		//info:  set defaults for options introduced in pro version 1.3
		if (get_option('leafletmapsmarker_version_pro') == '1.2.1' )
		{
			$new_options_defaults = array();
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p1.3')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		//info:  set defaults for options introduced in pro version 1.3.1
		if (get_option('leafletmapsmarker_version_pro') == '1.3' )
		{
			$new_options_defaults = array();
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p1.3.1')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		//info:  set defaults for options introduced in pro version 1.5
		if (get_option('leafletmapsmarker_version_pro') == '1.4' )
		{
			$new_options_defaults = array();
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p1.5')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
		...
		//info:  set defaults for options introduced in pro version 1.6
		if (get_option('leafletmapsmarker_version_pro') == '1.5.1' )
		{
			$new_options_defaults = array();
			foreach ( $this->settings as $id => $setting )
			{
				if ( $setting['type'] != 'heading' && $setting['type'] != 'helptext' && $setting['type'] != 'helptext-twocolumn' && $setting['version'] == 'p1.6')
				{
				$new_options_defaults[$id] = $setting['std'];
				}
			}
