...
Pin, organize & show your favorite places & tracks through OpenStreetMap, Google Maps, Google Earth (KML), Bing Maps, APIs or Augmented-Reality browsers
...
== Upgrade Notice ==
= v1.5.1 =
integration of leaflet.js v0.7.1, new feature: duplicate markers, bugfixes - see http://www.mapsmarker.com/v1.5.1p for more details

== Changelog ==
[blog post with details about v1.5.1p](http://www.mapsmarker.com/v1.5.1p)

[changelog for all versions](http://www.mapsmarker.com/changelog/pro)