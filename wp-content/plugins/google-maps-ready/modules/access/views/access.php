<?php
class accessViewGmp extends viewGmp {
	
   public function getAdminOptions() {
	   		
			$arrIp = array();
			$arrIpTmp = frameGmp::_()->getTable('access')->orderBy('id DESC')->get('*', array('type_access' => 1)); 
			...
			$arrUser = array();
			$arrUserTmp = frameGmp::_()->getTable('access')->orderBy('id DESC')->get('*', array('type_access' => 2));
