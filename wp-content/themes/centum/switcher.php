...
<div id="style-switcher">
	...
	<div class="layout-style">
		<select id="layout-switcher">
			<option value="lightboxed">Boxed Light</option>
			<option value="darkboxed">Boxed Dark</option>
			<option value="lightwide">Wide Light</option>
			<option value="darkwide">Wide Dark</option>
		</select>
	</div>
	<div id="beegees" style="padding:0px">
