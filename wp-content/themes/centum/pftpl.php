...
?>
<style type="text/css">
@media only screen and (min-width: 960px) {#portfolio-wrapper iframe, #portfolio-wrapper img {min-height: 290px;}}
		...
		<div <?php post_class('eight columns portfolio-item'); ?> id="post-<?php the_ID(); ?>" >
			...
			if($type == 'video' && $videothumbtype == 'video') {
				...
				if($videoembed) {
					...
					$post_embed = $wp_embed->run_shortcode('[embed  width="460" height="290"]'.$videolink.'[/embed]') ;
			...
			<div class="item-description alt">
				...
				$short_excerpt = string_limit_words($excerpt,25);
