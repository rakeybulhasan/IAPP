...
<div class="container">
    ...
    <div class="twelve columns <?php if ($sidebar_side == "left-sidebar") {
        ...
        <?php while (have_posts()) : the_post(); ?>
            ...
            <?php
            $objectives = get_post_meta($post->ID, 'project_objective', true);
            if (!empty($objectives)) {
                ?>
                <div class="twelve columns">
                    <div class="headline low-margin"><h4><?php _e('Project Objectives', 'purepress')?></h4></div>
                </div>
                ...
                <div class="twelve columns">
                    ...
                    echo project_objectives($objectives);
                    ?>
                </div>
            <?php } ?>

            <?php
            $funding = get_post_meta($post->ID, 'funding', true);
            if (!empty($funding)) {
                ?>

                <div class="twelve columns">
                    <div class="headline low-margin"><h4><?php _e('Funding', 'purepress')?></h4></div>
                </div>
                ...
                <div class="twelve columns">
                    ...
                    echo apply_filters('the_content', $funding);
                    ?>
                </div>
            <?php } ?>
