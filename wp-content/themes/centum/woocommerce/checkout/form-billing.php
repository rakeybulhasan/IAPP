...
<?php if ( $woocommerce->cart->ship_to_billing_address_only() && $woocommerce->cart->needs_shipping() ) : ?>
	...
	<div class="headline" style="margin-top: 5px;"><h3><?php _e( 'Billing &amp; Shipping', 'woocommerce' ); ?></h3></div>

<?php else : ?>

	<div class="headline" style="margin-top: 5px;"><h3><?php _e( 'Billing Address', 'woocommerce' ); ?></h3></div>
