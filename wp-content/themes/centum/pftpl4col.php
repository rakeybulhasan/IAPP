...
<style type="text/css">
	@media only screen and (min-width: 960px) {#portfolio-wrapper iframe {min-height: 147px;} #portfolio-wrapper img {min-height: 139px;}}
...
<div class="container">
	...
	<div id="portfolio-wrapper">
		...
		<div <?php post_class('four columns portfolio-item'); ?> id="post-<?php the_ID(); ?>" >
			...
			if($type == 'video' && $videothumbtype == 'video') {
				...
				<div class="picture"><a  href="<?php echo $thumbbig[0];?>"  rel="image" ><?php the_post_thumbnail(); ?><div class="image-overlay-zoom"></div></a></div>
				<?php } else { ?>
			...
			<div class="item-description alt">
				<h5><a href="<?php the_permalink(); ?>" title="<?php printf(esc_attr__('Permalink to %s', 'purepress'), the_title_attribute('echo=0')); ?>" rel="bookmark">
					<?php the_title(); ?>
				</a></h5>
				<?php
...
<div class="pagination">
	...
	<nav id="nav-below" class="navigation">
		<div class="nav-previous"><?php next_posts_link(__('&larr; Older items', 'purepress')); ?></div>
		<div class="nav-next"><?php previous_posts_link(__('Newer items &rarr;', 'purepress')); ?></div>
	</nav><!-- #nav-below -->
	<?php endif;
